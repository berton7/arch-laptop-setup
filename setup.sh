...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/berton7/arch-laptop-dotfiles"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/berton7/arch-laptop-setup/main/progs.csv"
